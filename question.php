...
<form action="questionH.php" method="POST" onsubmit="return check(this)">
	...
	<table>
		<tr>Heading:<br><textarea rows="1" cols="30" name="head"></textarea><span id='a' style="color: red;"></span></tr>
		<br/>
		<tr>Enter your question:<br/><textarea rows="3" cols="60" name="ta" ></textarea><span id='b' style="color: red;"></span></tr>
		<br/>
		<tr>
			<td>
